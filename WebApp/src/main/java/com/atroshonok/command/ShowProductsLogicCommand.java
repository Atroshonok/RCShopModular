...
public class ShowProductsLogicCommand {
    ...
    public void execute(HttpServletRequest request, IProductService productService, IProductCategoryService productCategoryService) {
	// for navbar and client filter in JSP
	categories = productCategoryService.getAllProductCategories();
